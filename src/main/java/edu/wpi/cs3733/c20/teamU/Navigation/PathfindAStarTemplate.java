...
public abstract class PathfindAStarTemplate implements PathfinderInterface {
    /*
    Class to pathfind
     */
    ...
    protected PathfindAStarTemplate() {

    }

    abstract int heuristic(Node current, Node n);
        ...
        while (!frontier.isEmpty()) {
            ...
            for (Node n : neighbors) {
                ...
                if (!costSoFar.containsKey(n) || newCost < costSoFar.get(n)) { //Either we've been here before, but this time we got here cheaper, or this is new
                    ...
                    int priority = newCost + heuristic(n, end);
